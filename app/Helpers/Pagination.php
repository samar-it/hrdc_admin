						...
						?>
							<div class="col-auto">
								<ul class="pagination pagination-sm mt-3">
									...
									?>
										<li class="page-item">
											<a class="page-link" title="First Page"><i class="icon dripicons-chevron-left"></i></a>
										</li>
									<?php
									}
									...
									?>
										<li class="page-item">
											<a class="page-link" title="Previous Page"><i class="icon dripicons-arrow-thin-left"></i></a>
										</li>
										<?php
									}
									...
									?>
										<li class="page-item">
											<a class="page-link" title="Next Page"><i class="icon dripicons-arrow-thin-right"></i></a>
										</li>
									<?php
									}
									//last button
									...
									?>
										<li class="page-item">
											<a class="page-link" title="Last Page"><i class="icon dripicons-chevron-right"></i></a>
										</li>
									<?php
									}
									?>
